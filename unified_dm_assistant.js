...
class UnifiedDMAssistant {
    ...
    async injectButtons(messageContainer) {
        ...
        // Check if this is a first DM or ongoing conversation
        const isFirstDM = this.isFirstDM();

        // Load appropriate configs based on conversation type
        const configs = await this.loadConfigs(isFirstDM);
            ...
            btn.addEventListener('click', async (e) => {
                ...
                const timeoutId = setTimeout(() => {
                    if (!isCancelled) {
                        ...
                        this.showError('AI generation timed out', buttonWrapper);
                ...
                try {
                    ...
                    // Get appropriate data based on conversation type
                    let response;
                    if (isFirstDM) {
                        const profileData = await this.gatherProfileData();
                        ...
                        // Personal DM with conversation context
                        ...
                        const lastMessageSender = lastMessageFromThem?.sender || participantData.name;
    ...
    isFirstDM() {
        // Check if this is a first DM by looking for existing messages
    ...
    async loadConfigs(isFirstDM) {
        if (isFirstDM) {
            ...
            return personalDmConfigs;
        }
    }

    async gatherProfileData() {
        return {
...
}¤â"(01ad515f478d4654d458bbf7cc45a59a21113f1c2Yfile:///c:/users/farih/OneDrive/Dokumenter/GitHub/Agentlink-Final/unified_dm_assistant.js:Afile:///c:/users/farih/OneDrive/Dokumenter/GitHub/Agentlink-Final